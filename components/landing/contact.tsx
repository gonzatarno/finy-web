...
const COPY = {
  es: {
    eyebrow: "Contacto",
    title: "Hablemos.",
    intro: "Soporte, propuesta de negocio o pedido de baja. Te respondemos en menos de 24 hs.",
    ...
    reasons: [
      ...
      { id: "baja"     as const, label: "Cancelar / dar de baja" },
    ...
    msgLabel: "Mensaje",
    msgPh: "Contanos en detalle qué necesitás…",
    ...
    errFallback: "No se pudo enviar. Probá de nuevo.",
    errOffline: "No se pudo conectar. Verificá tu conexión.",
  },
  en: {
    eyebrow: "Contact",
    title: "Let's talk.",
