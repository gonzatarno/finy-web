...
export const GUIDES: GuideMeta[] = [
  ...
  },
  {
    ...
    answer:
      "En una app de gastos, la IA sirve para tres cosas concretas: convertir lo que decís en voz en un movimiento cargado, leer tickets y resúmenes de tarjeta para no tipearlos, y responder preguntas sobre tu propio historial. Eso ataca el motivo real por el que la gente abandona estas apps, que es la fricción de carga. Lo que la IA no resuelve es decidir por vos en qué gastar, ni reemplazar la conexión con el banco: si una app promete que la IA te va a ordenar la vida financiera sola, está vendiendo humo.",
  },
]
